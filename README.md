...
**300IQ**는 청주시(상당구, 서원구, 청원구, 흥덕구)의 2025년 부동산 실거래가 데이터를 시각화하고, 사용자가 부동산 정책 및 매물에 대해 자유롭게 소통할 수 있는 커뮤니티 플랫폼입니다. 특히 Google Gemini AI를 활용하여 부동산 관련 질의응답을 제공합니다.
...
### 1. 🗺️ 부동산 데이터 시각화 (Data Visualization)
